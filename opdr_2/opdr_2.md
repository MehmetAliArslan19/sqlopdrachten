...
(first_name, last_name, email, address, postal_code, city, country_code, phone, created_at, updated_at)
VALUES
('Emma', 'Jansen', 'emma.jansen@example.com', 'Kerkstraat 22', '1017AB', 'Amsterdam', 'nl_NL', '0612345678', NOW(), NOW()),
('Ruben', 'Visser', 'ruben.visser@example.com', 'Marktplein 8', '3011TA', 'Rotterdam', 'nl_NL', '0687654321', NOW(), NOW())
